...
def getWinUILanguage() -> 'Get the default UI Language of Windows OS, a.k.a Display Language':
    #000. Info.
    '''
#---------------------------------------------------------------------------------------------------------------------------------------#
#100.   Introduction.                                                                                                                   #
...
#---------------------------------------------------------------------------------------------------------------------------------------#
    ...
    return( locale.windows_locale[ langdll.GetUserDefaultUILanguage() ] )
#End getWinUILanguage
...
if __name__=='__main__':
    ...
    print(getWinUILanguage.__doc__)

    #100. Retrieve Display Language for current Windows OS
    disp_lang = getWinUILanguage()
#-Notes- -End-
'''
