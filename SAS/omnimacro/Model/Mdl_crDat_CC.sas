...
|100.	Introduction.																													|
|---------------------------------------------------------------------------------------------------------------------------------------|
|	|This macro is intended to create the Category Count dataset for the modeling.														|
|	|The output dataset stores the frequency count of any category that appears in the text message.									|
|	|-----------------------------------------------------------------------------------------------------------------------------------|
|	|Table Structure:																													|
|	|-----------------------------------------------------------------------------------------------------------------------------------|
|	|         Variable Name          | Type | Len |     Format     |         Default Name           |            Description            |
|	|-----------------------------------------------------------------------------------------------------------------------------------|
|	| inCategory                     |  C   |  64 |      $64.      | Category                       |Category Value  Ù–‘÷µ              |
...
%if	%sysfunc(exist(&outDat.))	%then %do;
	...
	%put	%str(N)OTE: [&L_mcrLABEL.]CC Dataset already exists, program will delete it and create a new one.;
