...
IF (&inPDTCODE. IN ("713") )
	...
	THEN &outPDTCODE.="605 ";
IF (&inPDTCODE. IN ("824") )
	AND (&inCUSTSEG. NOT IN ("010","011","012","013","014","015","016","020","021","022","023","024","025","026","027","028","029","110","111","112","113","114","115","116","117","118","119","120","121","122","123","124") )
	THEN &outPDTCODE.="285 ";
IF (&inPDTCODE. IN ("325") )
	AND (&inCUSTSEG. IN ("025") )
	THEN &outPDTCODE.="220 ";
IF (&inPDTCODE. IN ("324") )
	...
	THEN &outPDTCODE.="220 ";
IF (&inPDTCODE. IN ("267") )
	AND (&inCUSTSEG. IN ("010","011","012","013","014","015","016","020","021","022","023","024","025","026","027","028","029","110","111","112","113","114","115","116","117","118","119","120","121","122","123","124") )
	THEN &outPDTCODE.="220 ";
IF (&inPDTCODE. IN ("752") )
...
IF (&inACCLSS. IN ("291701") )
	AND (&inCUSTSEG. IN ("010","011","012","013","014","015","016","020","021","022","023","024","025","026","027","028","029","110","111","112","113","114","115","116","121","122","123","124") )
	THEN &outPDTCODE.="225 ";
...
IF (&inACCLSS. IN ("231001") )
	...
	AND (&inPEBAL. LE (0) )
	AND (&inCUSTSEG. NOT IN ("010","011","012","013","014","015","016","020","021","022","023","024","025","026","027","028","029","110","111","112","113","114","115","116","121","122","123","124") )
	THEN &outPDTCODE.="295 ";
IF (&inACCLSS. IN ("291701") )
	AND (&inPDTCODE. IN ("630") )
	AND (&inPEBAL. LE (0) )
