...
%*                                                                                       ;
%* This is the same as %format_default, except without frozen panes or row height.       ;


%macro format_default_nofprh;
  %* 'No Freeze Panes or Row Height'                                                     ;
