...
%****************************************************************************************;
%*                                                                                       ;
%* exportToXL version 1.00 -- 9/17/2007                                                  ;
%*                                                                                       ;
%* SOURCE   : exportToXL.sas                                                             ;
%*                                                                                       ;
...
%*               'c:\temp\Some data.xls', which will have one worksheet, named 'Sheet1'  ;
...
%*               existing Excel spreadsheet, 'n:\sasok\data\blank dox\Serious Fun.xls',  ;
%*               and saved as 'c:\temp\Some data.xls'. The block of data is wanted at    ;
