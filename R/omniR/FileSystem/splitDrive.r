...
#   |[2] Unlike <Python&lt;=3.9>, <splitDrive('\\\\NET DRIVE\\base')> and <splitDrive('\\\\NET DRIVE\\base\\')> returns the same result #
#   |     as the file separators are automatically handled                                                                              #
#---------------------------------------------------------------------------------------------------------------------------------------#
#200.   Glossary.                                                                                                                       #
#---------------------------------------------------------------------------------------------------------------------------------------#
#   |100.   Parameters.                                                                                                                 #
...
#   |-----------------------------------------------------------------------------------------------------------------------------------#
#   |<list>      :   List of <chr> vectors with names of <drive> and <relative path> as the split result                                #
#---------------------------------------------------------------------------------------------------------------------------------------#
#300.   Update log.                                                                                                                     #
#---------------------------------------------------------------------------------------------------------------------------------------#
