...
#   |100.   Parameters.                                                                                                                 #
#   |-----------------------------------------------------------------------------------------------------------------------------------#
#   |interval    :   Either character string or a valid <dict> holding items generated by function <Dates.getDateIntervals>             #
#   |                 value, while the functions raises error if it is NOT provided.                                                    #
#   |                 [<str>       ]           See definition of <Dates.getDateIntervals> for accepted values                           #
...
#   |                 [W           ]           Working Days                                                                             #
#   |                 [T           ]           Trading Days                                                                             #
#   |col_rowidx  :   Column name representing the record index within the whole output calendar, with <dtype == int64>                  #
#   |                 [_ical_row_  ] <Default> The default column name                                                                  #
#   |                 [<str>       ]           Any valid character string as column name                                                #
#   |col_period  :   Column name representing the <period> in the output calendar, with <dtype == int64>                                #
#   |                 [_ical_prd_  ] <Default> The default column name                                                                  #
#   |                 [<str>       ]           Any valid character string as column name                                                #
#   |col_prdidx  :   Column name representing the record index within each <period> in the output calendar, with <dtype == int64>       #
#   |                 [_ical_rprd_ ] <Default> The default column name                                                                  #
#   |                 [<str>       ]           Any valid character string as column name                                                #
#   |col_weekday :   Column name representing the record flag of <weekday> in the output calendar, with <dtype == bool>                 #
