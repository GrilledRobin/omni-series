...
#   |                [InfDat          ] : Character string as the name of Information Table, or its <prefix> if <SingleInf=False>       #
...
#   |                [_trans_opt      ] : Additional options for value translation on <_trans>, see document for <AdvOp.apply_MapVal>   #
#   |                                     [<preset>] <Default> Same as the universal parameter <fTrans_opt>                             #
#   |                                     [<dict>  ]           Use alternative options as provided by a dict, see <apply_MapVal>        #
...
#   |                 converted to a <list> with date values                                                                            #
...
#   |                [<str>           ]            Only a single character string is accepted; the first is taken if a vector is        #
...
#   |values_fn   :   The same parameter as passed into function <pandas.pivot_table> to summarize the column <A_KPI_VAL>                #
...
#   |kw          :   The additional arguments for <pandas.pivot_table>                                                                  #
