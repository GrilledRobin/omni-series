...
%macro sasToXLrpt(
	...
	%local	exChkStrVar	exChkStrVarN	exChkStrDat	exChkStrDatN;
	%local	L_mcrLABEL;
	...
	%STXR_LocateCell
	%* Retrieve the positions of all cells containing the key-characters we require.;

	%STXR_DumpTTL(
		varhdr=&varheader.
		,vardat=exr_WORK.xlvartbl
	)
	%* Pours the data in.;
	...
	%* This is abandoned due to usage restriction.;
