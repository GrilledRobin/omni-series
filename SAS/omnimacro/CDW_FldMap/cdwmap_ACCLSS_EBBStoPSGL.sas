...
IF (&inACCLSS.	IN	("503077"))
	THEN &outACCT.="503077";
IF (&inACCLSS.	IN	("231007"))
	AND (&inPEBAL.	GE	(0))
	THEN &outACCT.="231001";
IF (&inACCLSS.	IN	("931002"))
	THEN &outACCT.="231001";
IF (&inACCLSS.	IN	("576001"))
	THEN &outACCT.="576001";
IF (&inACCLSS.	IN	("288821"))
	THEN &outACCT.="288821";
IF (&inACCLSS.	IN	("288873"))
	THEN &outACCT.="288873";
...
IF (&inACCLSS.	IN	("289006"))
	THEN &outACCT.="289006";
IF (&inACCLSS.	IN	("491505"))
	THEN &outACCT.="491505";
IF (&inACCLSS.	IN	("289952"))
	THEN &outACCT.="289952";
IF (&inACCLSS.	IN	("288832"))
	THEN &outACCT.="288832";
IF (&inACCLSS.	IN	("231010"))
	AND (&inPEBAL.	GE	(0))
	THEN &outACCT.="231001";
...
IF (&inACCLSS.	IN	("288896"))
	THEN &outACCT.="288896";
IF (&inACCLSS.	IN	("231011"))
	AND (&inPEBAL.	GE	(0))
	THEN &outACCT.="231001";
IF (&inACCLSS.	IN	("122321"))
	THEN &outACCT.="122321";
IF (&inACCLSS.	IN	("547978"))
	THEN &outACCT.="547978";
...
IF (&inACCLSS.	IN	("231013"))
	AND (&inPEBAL.	GE	(0))
	THEN &outACCT.="231001";
IF (&inACCLSS.	IN	("231006"))
	AND (&inPDTCODE.	IN	("243"))
	THEN &outACCT.="231013";
IF (&inACCLSS.	IN	("231012"))
	AND (&inPEBAL.	GE	(0))
	THEN &outACCT.="231001";
