...
def winUserShellFolders( *arg , inplace = True , **kw ) -> str | tuple | dict:
    #000. Info.
    '''
#---------------------------------------------------------------------------------------------------------------------------------------#
#100.   Introduction.                                                                                                                   #
...
#   |100.   Parameters.                                                                                                                 #
#   |-----------------------------------------------------------------------------------------------------------------------------------#
#   |*arg        :   <str > Any positional arguments that represent <special folder names> for search in Windows COM                    #
...
#   |-----------------------------------------------------------------------------------------------------------------------------------#
#   |   |pywintypes, win32com, collections                                                                                              #
#   |-----------------------------------------------------------------------------------------------------------------------------------#
