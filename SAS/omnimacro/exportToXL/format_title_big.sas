...
%*                                                                                       ;
%* FONT: MS Sans Serif, 18 pt, bold, centered                                           ;
...
%macro format_title_big;
  ...
  data _null_;
    ...
    put ddecmd;
    ddecmd = "[&formatfont"||'("MS Sans Serif"'||",18,&true,&false,&false,&false,0,&false,&false)]";
	put ddecmd;
	put "[&alignment(3)]";
  run;

%mend format_title_big;
