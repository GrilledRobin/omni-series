...
# scr_name = r'D:\Python\Programs\ScraperTemplate_noArg\PGM\main.py'
...
from omniPy.AdvOp import exec_file, getWinUILanguage, customLog, PrintToLog, thisShell, alignWidth
from omniPy.FileSystem import winKnownFolders, getMemberByStrPattern, winReg_getInfByStrPattern
...
for i,pgm in enumerate(pgms_curr):
    ...
    logger.info('-' * 40)
    logger.info(f'<{fname_scr}> Beginning...')
    ...
    logger.info(f'<{fname_scr}> Complete!')
